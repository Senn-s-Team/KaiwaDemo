/**
 * [INPUT]: 依赖 shared 场景草拟请求类型，以及 Cloudflare Worker 注入的 secrets、模型配置与 Workflow binding
 * [OUTPUT]: 提供 Env 配置接口，定义场景草拟、反馈任务和模型运行时边界
 * [POS]: Worker runtime 配置契约，集中连接短期任务 Workflow
