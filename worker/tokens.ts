/**
 * [INPUT]: 依赖 zod、Worker 环境密钥，以及动态场景、场景/会话/任务 token 契约
 * [OUTPUT]: 提供场景、会话、长期复练、短期任务 capability 的签发、验证、claims 类型和结构化 TokenError
 * [POS]: worker 的 HMAC 可信边界，通过用途、身份、过期和严格 schema 隔离训练与任务权限
